...
class AccountVar extends React.Component {
    ...
    render() { 
        ...
        if(this.props.datiAccount.Accesso) return <li className="nav-item"><Link class="nav-link breadcrumb-item active" aria-current="page" to="/Account">{this.props.datiAccount.Email}</Link></li>
        else
            return (  
